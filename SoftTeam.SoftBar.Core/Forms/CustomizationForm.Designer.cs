namespace SoftTeam.SoftBar.Core.Forms
{
    partial class CustomizationForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.xtraScrollableControlMenu.Size = new System.Drawing.Size(754, 438);
    ...
    "check box) of creating sections in your menu";
            ...
            toolTipItem6.Text = "Exits the customization form without saving.";
            toolTipTitleItem7.LeftIndent = 6;
            toolTipTitleItem7.Text = "Warning: You will loose all customizations you have made!";
            ...
            toolTipItem7.Text = "Creates a new button on the application bar, and a top level drop down menu once " +
    "you have added at least one sub menu, header item or menu item to the menu.";
            ...
            toolTipItem8.Text = "Adds a sub menu to a menu or a sub menu.\r\n\r\nA sub menu can contain more sub menus" +
    ", header items, and menu items.";
            ...
            toolTipTitleItem10.Text = "Add header item";
            toolTipItem9.LeftIndent = 6;
            toolTipItem9.Text = "A header item is an alternative way (alternative to using the <b>begin group</b> " +
    "check box) of creating sections in your menu";
            ...
            toolTipItem10.Text = "Adds a menu item to start an application or document.";
